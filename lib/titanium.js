...
// check if a new version of titanium CLI is available every hour and print an update notification
const updateNotifier = require('update-notifier');
const notifier = updateNotifier({ pkg: pkgJson, updateCheckInterval: 1000 * 60 * 60 });
if (notifier.update && notifier.update.latest !== pkgJson.version) {
