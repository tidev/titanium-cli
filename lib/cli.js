	...
	var missingOptions = [],
		...
		scanOptions = function (opts) {
			opts && Object.keys(opts).forEach(function (name) {
				...
				if ((!argv.hasOwnProperty(name) || argv[name] == void 0) && (!opts[name].platform || opts[name].platform == platform)) {
					opts[name].required && missingOptions.push(obj.opt);
