	...
	if (types.all || types.android) {
		...
		if (data.android) {
			logger.log(__('Android').bold + '\n' +
				'  ' + rpad(__('Android Executable')) + ' = ' + cyan(data.android.exe) + '\n' +
				'  ' + rpad(__('SDK Path'))           + ' = ' + cyan(data.android.sdkPath) + '\n' +
				'  ' + rpad(__('NDK Path'))           + ' = ' + cyan(data.android.ndk.path) + '\n' +
				'  ' + rpad(__('NDK Version'))        + ' = ' + cyan(data.android.ndk.version) + '\n' +
				'  ' + rpad(__('JDK Version'))        + ' = ' + cyan(data.android.java.version ? data.android.java.version + '_' + data.android.java.build : 'not installed') + '\n'
			);
