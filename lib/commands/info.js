	...
	if (types.all || types.android) {
		...
		if (data.android) {
			logger.log(__('Android').bold + '\n' +
				'  ' + rpad(__('Android Executable')) + ' = ' + cyan(data.android.exe || __('not installed')) + '\n' +
				'  ' + rpad(__('SDK Path'))           + ' = ' + cyan(data.android.sdkPath || __('not installed')) + '\n' +
				'  ' + rpad(__('NDK Path'))           + ' = ' + cyan(data.android.ndk ? data.android.ndk.path : __('not installed')) + '\n' +
				'  ' + rpad(__('NDK Version'))        + ' = ' + cyan(data.android.ndk ? data.android.ndk.version : __('not installed')) + '\n' +
				'  ' + rpad(__('JDK Version'))        + ' = ' + cyan(data.android.java && data.android.java.version ? data.android.java.version + '_' + data.android.java.build : __('not installed')) + '\n'
			);
			...
			var androidAvds = sections['Android AVDs'] = {};
