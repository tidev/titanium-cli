...
logger.banner = function () {
	...
	if (bannerEnabled) {
		logger.log('Titanium CLI v' + info.version + (logger.activeSdk ? ', SDK v' + logger.activeSdk : '') + ', ' + 'https://titaniumsdk.com'.cyan);
		logger.log(__('Want to help? %s or %s', 'https://tidev.io/donate'.cyan, 'https://tidev.io/contribute'.cyan) + '\n');
