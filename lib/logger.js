...
var path = require('path'),
	...
	consoul = new winston.transports.Console({
		level: config.cli.logLevel || 'info',
...
logger.banner = function () {
	...
	if (bannerEnabled) {
		logger.log(info.about.name.cyan.bold + ', version ' + info.version + '\n' + info.about.copyright + '\n');
		logger.log(__('Please report bugs to %s', 'http://jira.appcelerator.org/'.cyan) + '\n');
	}
	bannerEnabled = false;
};
