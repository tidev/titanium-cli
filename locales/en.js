{
	...
	"outputs results using old format": "outputs results using old format",
	...
	"CLI Tools Installed": "CLI Tools Installed",
	...
	"Active Titanium SDK '%s' not found": "Active Titanium SDK '%s' not found",
	"Run '%s' to set the active Titanium SDK.": "Run '%s' to set the active Titanium SDK.",
	"used to select which installed Titanium SDK is the active SDK": "used to select which installed Titanium SDK is the active SDK",
	...
	"No SDK version supplied": "No SDK version supplied",
	"Usage: %s": "Usage: %s",
	...
	"no Xcode installations found": "no Xcode installations found",
	"CLI Tools": "CLI Tools",
	"not found for Xcode %s": "not found for Xcode %s",
	"select Titanium SDK 3.2 or newer to detect": "select Titanium SDK 3.2 or newer to detect",
	"WWDR cert": "WWDR cert",
	...
	"No Titanium SDKs found!": "No Titanium SDKs found!",
	"Specified Titanium SDK \"%s\" is too old": "Specified Titanium SDK \"%s\" is too old",
	"The most recent installed Titanium SDK \"%s\" is too old": "The most recent installed Titanium SDK \"%s\" is too old"
}