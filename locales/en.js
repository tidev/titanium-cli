{
	...
	"Leave blank if you don't want to build for Android.": "Leave blank if you don't want to build for Android.",
	...
	"up-to-date (%s)": "up-to-date (%s)",
	"new version %s available (currently %s)": "new version %s available (currently %s)",
	"bleeding edge (%s)": "bleeding edge (%s)",
	"update": {
		"one": "update",
		"other": "updates"
	},
